...
abstract class RemoteDataSource {
  Future<ProductModel> getProductItem();
...
class RemoteDataSourceImpl extends RemoteDataSource {
  ...
  @override
  Future<ProductModel> getProductItem() async {
    try{
      final response = await productMockdataList;
      ProductModel result = ProductModel.fromJson(productMockdataList);
      return result;
    }catch (e) {
      rethrow;
    }
